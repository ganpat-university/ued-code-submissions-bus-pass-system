...
<!Doctype HTML>
	...
	<div id="main">
		...
		<div class="head">
			<div class="col-div-6">
	<span style="font-size:30px;cursor:pointer; color: white;" class="nav"  > Users Request</span>
	<span style="font-size:30px;cursor:pointer; color: white;" class="nav2"  > Users Request</span>
	</div>
